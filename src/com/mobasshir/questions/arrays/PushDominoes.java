...
public class PushDominoes {
    public static String pushDominoes(String dominoes) {
        ...
        int n = sb.length();
        // mark true for all the block, after pushing a bloch in right direction
        char prev = '.';
        ...
        // mark true for all the block, after pushing a block in left direction
        prev = '.';
    ...
    private static void pushDominoesInBetween(StringBuilder sb, int l, int r) {
        while (l < r) {
            sb.setCharAt(l++, 'R');
            sb.setCharAt(r--, 'L');
        }
